...
--
-- HISTORICAL ROLLOUT BUNDLE. Superseded by
-- 2026-08-04-moc-console-target-schema-cleanup.sql. Keep this file for audit
-- history; do not run it against the current target schema.
--
