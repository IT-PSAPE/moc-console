...
import { getCategoryLabel, priorityLabel } from '@moc/types/requests'
        ...
        <ListItemCard.Root>
            <ListItemCard.Content>
                ...
                <ListItemCard.Meta>
                    ...
                    <ListItemCard.MetaItem icon={<Tag />}>{getCategoryLabel(request.category, request.categoryName)}</ListItemCard.MetaItem>
                    {request.dueDate && (
