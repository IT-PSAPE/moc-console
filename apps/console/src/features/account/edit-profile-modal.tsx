        ...
        <Modal.Portal>
          ...
          <Modal.Positioner>
            <Modal.FullScreenPanel className="w-full md:!max-w-lg">
                  ...
                  <div className="flex flex-col gap-5 p-4">
                    ...
                    <div className="grid gap-3 sm:grid-cols-2">
                      <FormField label="First name" required>
                        <Input aria-label="First name" autoComplete="given-name" name="given-name" value={state.name} onChange={handleNameChange} placeholder="First name" />
                      </FormField>
                      <FormField label="Last name" required>
                        <Input aria-label="Last name" autoComplete="family-name" name="family-name" value={state.surname} onChange={handleSurnameChange} placeholder="Last name" />
                      </FormField>
                    </div>
                    ...
                    <FormField label="Duty" optional>
                      <Input aria-label="Duty" autoComplete="off" name="duty" value={state.duty} onChange={handleDutyChange} placeholder="e.g. Camera operator" />
                    </FormField>

                    <FormField label="Status" optional>
                      <TextArea aria-label="Status" autoComplete="off" name="status" value={state.status} onChange={handleStatusChange} placeholder="What's on your mind?" rows={2} maxLength={PROFILE_STATUS_MAX_LENGTH} />
              ...
              <Modal.Footer>
                <Button variant="secondary" onClick={actions.close}>Cancel</Button>
