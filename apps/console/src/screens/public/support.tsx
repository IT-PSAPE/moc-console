  ...
  return (
    <PublicLayout>
      ...
      <Section title="Common questions">
        ...
        <PublicDocumentFaq question="How do I disconnect Zoom?">Open <em>Settings → Streaming connections</em> and click <strong>Disconnect</strong>. This revokes the OAuth token with Zoom and removes the stored connection while retaining existing meeting metadata. If you remove the app through the Zoom Marketplace, MOC Console deletes the connection, tokens, and Zoom meeting metadata when Zoom sends the removal notification.</PublicDocumentFaq>
