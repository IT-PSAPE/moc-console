...
const REQUEST_SAMPLE: TokenValues = {
  ...
  dueDate: "21 May, 5:00 PM",
  createdAt: "18 May, 8:12 AM",
  updatedAt: "18 May, 9:30 AM",
...
const BOOKING_SAMPLE: TokenValues = {
  ...
  bookedBy: "Rumbi K.",
  checkedOutAt: "22 May, 7:00 AM",
  expectedReturnAt: "24 May, 8:00 PM",
  returnedAt: "",
...
export const SAMPLE_TOKENS: Record<MessageType, TokenValues> = {
  "stream.created": {
    ...
    scheduledStartTime: "18 May, 9:00 AM",
    actualStartTime: "",
    status: "created",
  ...
  "assignment.cue": {
    ...
    eventScheduledAt: "18 May, 9:00 AM",
  ...
  "assignment.checklist_item": {
    ...
    checklistScheduledAt: "18 May, 8:00 AM",
