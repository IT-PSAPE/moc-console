...
const trackVariants = cv({
    base: [
        'relative inline-flex shrink-0 rounded-full transition-colors after:absolute after:top-1/2 after:left-1/2 after:size-11 after:-translate-x-1/2 after:-translate-y-1/2 md:after:hidden',
