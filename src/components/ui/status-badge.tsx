...
const STATUS_STYLES: Record<string, string> = {
  ...
  in_use: 'bg-utility-blue-50 text-utility-blue-700 border-utility-blue-200',
  faulty: 'bg-utility-error-50 text-utility-error-700 border-utility-error-200',
  returned: 'bg-utility-success-50 text-utility-success-700 border-utility-success-200',
  overdue: 'bg-utility-error-50 text-utility-error-700 border-utility-error-200',
  active: 'bg-utility-warning-50 text-utility-warning-700 border-utility-warning-200',
  resolved: 'bg-utility-success-50 text-utility-success-700 border-utility-success-200',
...
const DOT_COLORS: Record<string, string> = {
  ...
  in_use: 'bg-utility-blue-500',
  faulty: 'bg-utility-error-500',
  returned: 'bg-utility-success-500',
  overdue: 'bg-utility-error-500',
  active: 'bg-utility-warning-500',
  resolved: 'bg-utility-success-500',
